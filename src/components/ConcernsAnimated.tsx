...
const concernsData: Concern[] = [
  ...
  },
  {
    ...
    description: "21,000+ videos reviewed by Islamic scholars. Zero exposure to harmful content. Our curated library ensures your children only see what's appropriate.",
    icon: `<svg class="w-full h-full" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

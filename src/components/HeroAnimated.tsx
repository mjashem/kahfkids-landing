        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
            ...
            <div className="lg:col-span-7 space-y-4 lg:space-y-6 text-center lg:text-left">
              ...
              <AnimatedSection animation="slideRight" delay={0}>
                <motion.h1
                  ...
                  >
                    Worried About Screen Time? Take{' '}
                    <motion.span
              ...
              <AnimatedSection animation="fadeUp" delay={0.3}>
                <div className="space-y-2">
                  ...
                  >
                    <span className="inline-flex items-center gap-1 text-sm font-medium bg-gray-100 text-gray-700 px-3 py-1.5 rounded-full">
              ...
              <AnimatedSection animation="fadeUp" delay={0.4} className="hidden lg:block">
                <div className="space-y-2 flex flex-col items-start">
                  <p className="text-base lg:text-lg text-[#4a4b4d] font-['Baloo_2:Medium',_sans-serif]">
                    Available on:
                  </p>
                  <motion.div
                  ...
                  >
                    <img
                      ...
                      className="w-full max-w-[320px] xl:max-w-[360px] h-auto object-contain"
                    />
                  </motion.div>
                </div>
              </AnimatedSection>
            ...
            <AnimatedSection animation="fadeUp" delay={0.5} className="lg:hidden block col-span-1">
              <div className="space-y-2 flex flex-col items-center justify-center pt-4">
                <p className="text-base text-[#4a4b4d] font-['Baloo_2:Medium',_sans-serif]">
                  Available on:
                </p>
                <motion.div
                  initial={{ opacity: 0, scale: 0.95 }}
                ...
                >
                  <picture>
                    ...
                    <img
                      src={`${base}/platform-group.png`}
                      alt="Available on iOS, Android, Android TV, Fire TV, Kindle, and Web"
                      className="w-full max-w-[240px] sm:max-w-[320px] md:max-w-[360px] h-auto object-contain"
                    />
                  </picture>
                </motion.div>
              </div>

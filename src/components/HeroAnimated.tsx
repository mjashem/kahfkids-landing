  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute -bottom-2 lg:-bottom-0 left-0 right-0 z-10" style={{ height: '23px' }}>
      ...
      <div className="relative h-full pt-2 lg:pt-16">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl h-full">
          <div className="flex flex-col lg:flex-row items-start lg:items-start justify-between h-full w-full gap-0 lg:gap-16">
            ...
            <AnimatedSection animation="slideRight" delay={0.2} className="flex-1 lg:flex-[2] text-center lg:text-left order-1 lg:order-1">
              ...
              >
                ...
                <div className="flex gap-3 w-full sm:w-auto">
                  <div className="flex-1 sm:flex-initial sm:w-[162px] h-12">
                    <img
            ...
            {/* iPhone Mockup */}
            <motion.div
              className="flex-1 lg:flex-[1] flex justify-center lg:justify-end order-1 lg:order-2 lg:mt-6 relative z-20"
              initial={{ opacity: 0, x: 100 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 1, delay: 0.6, ease: "easeOut" }}
            >
              <div className="relative w-full lg:w-auto origin-top" style={{ marginBottom: '-80px' }}>
                <img
                  src="/iPhone-11.png"
                  alt="iPhone 11 with Kahf Kids App"
                  className="w-full h-auto object-contain lg:w-auto lg:h-auto"
                  style={{
                    maxHeight: '600px'
                  }}
                />
